...
# 如需深色背景样式，可在这里启用 `dark_background`。
fig = plt.figure()
...
ax.set_yticklabels(map(str, [x * 100 + 400 for x in range(1, 7)]), size='small')
ax.set_zticklabels(map(str, [x * 10000 for x in range(1, 13)]), size='small')
